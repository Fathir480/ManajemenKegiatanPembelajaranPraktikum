# Rencana Pembuatan Website Manajemen Kegiatan Pembelajaran dan Praktikum
...
admin:
 ...
 - Menentukan stambuk mahasiswa
 - Menentukan nomor induk dosen
 - Menentukan jadwal kegiatan praktikum
 - Validasi ajuan perpindahan jadwal
 - Manajemen mata kuliah/praktikum

asisten:

 - Input absensi mahasiswa/praktikan (manual dan scan QR)
 - Input nilai praktikum - asistensi
 - Mengajukan perpindahan jadwal
 - Eksport nilai ke excel atau pdf

dosen:

 - Input nilai uts dan uas
 - Mengajukan perpindahan jadwal
 - Upload materi dan modul
 - Melihat rekap nilai keseluruhan

praktikan:

 - Melihat detail nilai praktikan
 - Melihat jadwal kegiatan praktikum
 - Melihat rekap absensi

### Color Palent

- pacific-blue: #0fa3b1ff;
- honeydew: #d9e5d6ff;
- vanilla-custard: #eddea4ff;
- tangerine-dream: #f7a072ff;
- sandy-brown: #ff9b42ff;
