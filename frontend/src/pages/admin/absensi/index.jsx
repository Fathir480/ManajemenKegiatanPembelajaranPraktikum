            ...
            <table className="absensi-table" style={{ width: 'max-content', minWidth: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr>
                  ...
                  {sessions.map(s => (
                    <th key={s.id} style={{ minWidth: '120px', textAlign: 'center', background: 'var(--surface-soft)', color: 'var(--ink)' }}>
                      <div className="text-mono" style={{ fontSize: '10px', color: 'var(--muted)', fontWeight: 400 }}>
                ...
                {students.map(std => (
                  <tr key={std.id}>
                    ...
                    {sessions.map(s => {
                      ...
                      return (
                        <td key={s.id} style={{ textAlign: 'center', verticalAlign: 'middle', padding: '10px 8px' }}>
                          <select
                            ...
                            style={{
                              ...
                              fontSize: '11px',
                              fontWeight: 600,
                              borderRadius: '0px', // strict admin styling
                              padding: '4px 8px',
